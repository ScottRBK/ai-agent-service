...
def create_evaluation_config() -> EvaluationConfig:
    ...
    return EvaluationConfig(
        ...
        metrics=metrics,
        contexts=contexts,
        dataset_name=f"{agent_id}_temporal_awareness_eval",
        dataset_file=f"{agent_id}_temporal_awareness_eval.json",
        results_file=f"{agent_id}_temporal_awareness_eval.json"  
    )
